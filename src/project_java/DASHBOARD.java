...
Connection conn=null;
    ...
    private void initComponents() {
        ...
        Piechart.setBounds(620, 280, 170, 32);
...
UserProfile up = new UserProfile();
    ...
    private void PiechartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PiechartActionPerformed
        ...
        try{
            String sql ="select count(user_role) from users where user_role='Administrator';";
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
            if(rs.next()){
        ...
        DefaultPieDataset peiDataset = new DefaultPieDataset();
        peiDataset.setValue("Administrator", new Integer(admin));
        peiDataset.setValue("Pharmacist", new Integer(phar));
        peiDataset.setValue("Costumer",new Integer(cust));
        JFreeChart chart= ChartFactory.createPieChart3D("Pie Chart",peiDataset,true,true,true);
